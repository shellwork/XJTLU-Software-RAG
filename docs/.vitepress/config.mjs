    ...
    sidebar: [
      {
        text: 'Project Brief',
        items: [
          { text: 'Project Overview', link: '/project-introduction' }
        ]
      },
      {
        text: 'Quick Start',
        items: [
          {text: 'Set up and Installation', link: '/install'}
        ]
      },
      {
        ...
        items: [
          ...
          {text: 'Data loader', 
           items: [
            ...
            {text: 'PDF loader', link: '/functions/pdf-loader'},
