...
def knowledge_base_page():
    ...
    if selected_kb == "Create New Knowledge Base":
        with st.form("Create New Knowledge Base"):
            ...
            embed_model = st.selectbox("Embeddings Model", ["openai", "Local"], index=0)
        ...
        with st.expander("File Processing Configuration"):
            ...
            chunk_overlap = st.number_input("Overlap length between adjacent chunks:", min_value=0, max_value=100, value=20)
            zh_title_enhance = st.checkbox("Enable Chinese Title Enhancement", value=False)
